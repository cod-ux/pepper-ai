...
def copy_excel_locally(file):
    ...
    file_root = os.path.join("/home/ubuntu/Github/reporter/uploads", new_fname)
    original_path = os.path.join("/home/ubuntu/Github/reporter/", old_fname)
    with open(file_root, "wb") as local_file:
        local_file.write(file.read())
    st.success(f"File saved as {new_fname}")

    file_path = f"/home/ubuntu/Github/reporter/uploads/{new_fname}"
