...
- ALWAYS return the python code to import pandas, even if code is not required. \n
- ALWAYS print the answer that you find at the end of the program. This will provide the user with the answer to their question. \n
- ALWAYS save any graphs you make with seaborn as images in the folder "/Users/suryaganesan/vscode/ml/projects/reporter/ph_images" at the end of the program. This will provide the user with the answer to their question. \n
...
providing a logical and concise answer to the user's question. Never include any file path names or information about saving images in teh final response: """
            ),
            (
                'placeholder',
                '{messages}'
