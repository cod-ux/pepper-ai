...
def copy_excel_locally(file):
    ...
    file_root = os.path.join("/Users/suryaganesan/Documents/GitHub/reporter/uploads", new_fname)
    original_path = os.path.join("/Users/suryaganesan/Documents/GitHub/reporter/", old_fname)
    with open(file_root, "wb") as local_file:
        local_file.write(file.read())

    file_path = f"/Users/suryaganesan/Documents/GitHub/reporter/uploads/{new_fname}"
